...
public class GBNServer {
    ...
    private void sendData() throws Exception {
        ...
        while (nextSeq < base + N && nextSeq <= 5) {
            String filename="D:/ComputerScience/hitcs/hitcs/computer_network/labs/lab2/lab2/lab2/src/ServerFile/file"+nextSeq+".txt";
...
//            byte[] data = clientData.getBytes();
    ...
    public void timeOut() throws Exception {
        for(int i = base;i < nextSeq;i++){
            String filename="D:/ComputerScience/hitcs/hitcs/computer_network/labs/lab2/lab2/lab2/src/ServerFile/file"+i+".txt";
            File file=new File(filename);
            FileInputStream fis = new FileInputStream(file);
            byte[] bytes = new byte[512];
            fis.read(bytes, 0, bytes.length);
