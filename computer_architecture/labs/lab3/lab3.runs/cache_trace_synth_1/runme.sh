...
HD_PWD='C:/Users/ywy_c/Documents/coding/hitcoa_at2024/coa/release/lab3/lab3.runs/cache_trace_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_trace.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_trace.tcl
