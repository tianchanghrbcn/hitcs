...
(
    ...
    // debug signals
    input [31:0]    debug_wb_pc     ,  // 当�?正在执行指令的PC
    input           debug_wb_rf_wen ,  // 当�?通用寄存器组的写使能信�?�
    input [4 :0]    debug_wb_rf_addr,  // 当�?通用寄存器组写回的寄存器编�?�
    input [31:0]    debug_wb_rf_wdata  // 当�?指令�??�?写回的数�?�
