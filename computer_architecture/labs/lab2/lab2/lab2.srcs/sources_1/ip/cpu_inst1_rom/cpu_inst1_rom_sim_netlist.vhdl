...
-- Date        : Tue Sep 10 19:19:21 2024
-- Host        : ywy_c_asm_PC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/ywy_c/Documents/coding/hitcoa_at2024/coa/release/lab2/lab2.srcs/sources_1/ip/cpu_inst1_rom/cpu_inst1_rom_sim_netlist.vhdl
...
entity cpu_inst1_rom_rom is
  port (
    spo : out STD_LOGIC_VECTOR ( 18 downto 0 );
    a : in STD_LOGIC_VECTOR ( 4 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cpu_inst1_rom_rom : entity is "rom";
end cpu_inst1_rom_rom;

architecture STRUCTURE of cpu_inst1_rom_rom is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cpu_inst1_rom_dist_mem_gen_v8_0_13_synth is
  port (
    spo : out STD_LOGIC_VECTOR ( 18 downto 0 );
    a : in STD_LOGIC_VECTOR ( 4 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cpu_inst1_rom_dist_mem_gen_v8_0_13_synth : entity is "dist_mem_gen_v8_0_13_synth";
end cpu_inst1_rom_dist_mem_gen_v8_0_13_synth;

architecture STRUCTURE of cpu_inst1_rom_dist_mem_gen_v8_0_13_synth is
begin
\gen_rom.rom_inst\: entity work.cpu_inst1_rom_rom
     port map (
...
\synth_options.dist_mem_inst\: entity work.cpu_inst1_rom_dist_mem_gen_v8_0_13_synth
     port map (
      a(4 downto 0) => a(4 downto 0),
      spo(18) => \^spo\(31),
      spo(17 downto 15) => \^spo\(28 downto 26),
      spo(14) => \^spo\(23),
      spo(13) => \^spo\(0),
      spo(12) => \^spo\(21),
      spo(11 downto 9) => \^spo\(18 downto 16),
      spo(8) => \^spo\(4),
      spo(7 downto 5) => \^spo\(13 downto 11),
      spo(4) => \^spo\(7),
      spo(3) => \^spo\(5),
