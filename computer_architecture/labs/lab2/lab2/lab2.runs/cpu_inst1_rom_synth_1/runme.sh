...
HD_PWD='C:/Users/ywy_c/Documents/coding/hitcoa_at2024/coa/release/lab2/lab2.runs/cpu_inst1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_inst1_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_inst1_rom.tcl
