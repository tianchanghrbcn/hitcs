...
if __name__ == "__main__":
    build_diagram(flows["build_graph"], flows["edges_build_graph"], "flow_build_graph")

    build_diagram(flows["show"], flows["edges_show"], "flow_show")

    build_diagram(flows["bridge"], flows["edges_bridge"], "flow_bridge")

    build_diagram(flows["newtext"], flows["edges_newtext"], "flow_newtext")

    build_diagram(flows["shortest"], flows["edges_shortest"], "flow_shortest")

    build_diagram(flows["pagerank"], flows["edges_pagerank"], "flow_pagerank")

    build_diagram(flows["walk"], flows["edges_walk"], "flow_walk")
