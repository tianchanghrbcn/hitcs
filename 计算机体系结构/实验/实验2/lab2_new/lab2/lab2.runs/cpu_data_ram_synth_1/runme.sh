...
HD_PWD='C:/Users/ywy_c/Documents/coding/hitcoa_at2024/coa/release/lab2/lab2.runs/cpu_data_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_data_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_data_ram.tcl
