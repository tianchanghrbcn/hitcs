...
#
# Generated by export_simulation on Tue Aug 20 19:34:28 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ans_ram.sh' script.

./ans_ram.sh -reset_run
...
./ans_ram.sh -noclean_files

For more information on the script, please type './ans_ram.sh -help'.
