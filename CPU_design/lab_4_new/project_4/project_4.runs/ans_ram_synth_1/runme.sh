...
HD_PWD='D:/computer science/project_4/project_4.runs/ans_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ans_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ans_ram.tcl
